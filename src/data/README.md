# RevQ — Sample Data Files

This folder contains **8 sample JSON data files** that simulate the real-world data RevQ would consume from various systems. All data is fictional but realistic, modeled after actual D2C brand operations on Blinkit, Zepto, and Instamart.
...
| `demand_forecasts.json` | 22 Forecasts | RevQ AI Engine | AI-predicted demand per SKU per store |
| `replenishment_suggestions.json` | 15 Suggestions | RevQ AI Engine | Auto-generated reorder alerts with urgency levels |
| `purchase_orders.json` | 15 POs | RevQ PO Generator | Auto-created purchase orders sent to suppliers |

---

## 🔗 How Data Flows in RevQ
...
RevQ AI Engine (uses all above) ───────────────────────────────────────────► demand_forecasts.json
...
**Note:** Suppliers with `api_integration: true` can receive orders automatically via RevQ's Autonomous Reorder Agent. Others receive orders via email.

---

### 7. `demand_forecasts.json` — AI Demand Predictions
**Source:** RevQ AI Engine (generated internally)
...
**Source:** RevQ PO Generator (generated internally)
...
> **For development/demo purposes**, these JSON files serve as mock data that replaces real API calls. In production, RevQ would replace these files with live API integrations.
...
*Generated by RevQ AI — March 31, 2026*
